...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-8">
        <div>
            <nav class="flex items-center gap-2 text-sm text-gray-500 mb-3">
                <a href="{{ route('usuarios.index') }}" class="hover:text-gray-700">Usuarios</a>
                <span>›</span>
                <span class="text-gray-700 font-medium">Editar usuario</span>
            </nav>

            <h1 class="text-3xl font-bold text-gray-900">Editar Usuario</h1>
            <p class="mt-1 text-sm text-gray-500">
                Actualiza la información, permisos y accesos del usuario.
            </p>
        </div>

        <a href="{{ route('usuarios.index') }}"
           class="inline-flex items-center justify-center rounded-xl border border-blue-200 bg-white px-4 py-2.5 text-sm font-semibold text-blue-700 hover:bg-blue-50 transition">
            ← Volver a usuarios
        </a>
    </div>
    ...
    <form method="POST" action="{{ route('usuarios.update', $user->id) }}">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                <div class="flex items-start gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Selecciona los permisos que tendrá el usuario en cada módulo.</p>
                    </div>
                </div>
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-2xl shadow-sm p-6">
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Define a qué sucursales y áreas tendrá acceso este usuario.</p>
                        </div>
                    </div>
                                ...
                                @foreach($areas as $area)
                                    <label class="border border-gray-200 rounded-xl p-3 block area-item bg-gray-50 hover:bg-gray-100 transition"
                                        ...
                                        <input type="checkbox"
                                               ...
                                               class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-2 align-middle">
            ...
            {{-- ACCIONES --}}
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-4 sm:p-5 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                <a href="{{ route('usuarios.index') }}"
                   class="inline-flex items-center justify-center rounded-xl border border-red-200 bg-white px-5 py-3 font-semibold text-red-600 hover:bg-red-50 transition">
                    Eliminar usuario
                </a>

                <div class="flex flex-col sm:flex-row gap-3 sm:ml-auto">
                    <a href="{{ route('usuarios.index') }}"
                       class="inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white px-5 py-3 font-semibold text-gray-700 hover:bg-gray-50 transition">
                        Cancelar
                    </a>

                    <button class="inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-3 shadow-md transition">
                        Actualizar usuario
                    </button>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Mostrar/ocultar submódulos de cualquier módulo padre
    document.querySelectorAll(".module-view").forEach(function (checkbox) {
        checkbox.addEventListener("change", function () {
            ...
            // Lógica especial solo para mantenimiento
            if (slug === "mantenimiento" && maintenanceSection) {
                if (checkbox.checked) {
